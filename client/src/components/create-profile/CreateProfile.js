            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <SelectListGroup
                  ...
                  error={errors.status}
                  options={options}
                  info="Give us and idea of where your are at in your career"
                />
                <TextFieldGroup
                  placeholder="Company"
                  name="company"
                  ...
                  info="Could be your own company or one that your work for"
                />
                <TextFieldGroup
                  placeholder="Website"
                  name="website"
...
export default connect(mapStateTopProps)(CreateProfile);
